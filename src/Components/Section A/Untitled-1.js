...
function Section1(){
    ...
    const handleNext = () => {
      ...
      const handleSave = async () => {
        const section = "Section A"; // Adjust as needed
        const question = `Question ${currentQuestion}`; // Replace with actual question text
                    ...
                    <div className="row-div row-col-div-ques">
                                ...
                                {['Sheep and Beef', 'Dairy Farming', 'Cropping', 'Deer Farming', 'Forestry', 'Other (please specify)'].map(option => (
                                    <div className='col-md-6 mb-1' key={option}>
                                        <input
                                            ...
                                            onChange={() => handleCheckboxChange('Question 1', option)}
                                        />
                                        <label className='btn btn-outline w-100' htmlFor={`btn-checked-${option}`}>
                                            {option}
                                        </label>
                                    </div>
                                ))}
                        ...
                        <div class='d-flex justify-content-between mb-3 wid-100 '>
                            <div>
                                ...
                                {/* {currentQuestion === totalQuestions && (
                                    <Link to="/section2" className="btn btn-outline-primary">
                                        Next <i class="bi bi-chevron-right" style={{marginLeft:'4px'}}></i>
                                    </Link>
                                )} */}
                                {currentQuestion === totalQuestions && (
                                    <button onClick={handleSave} className="btn btn-outline-primary">
                                        Save and Next <i className="bi bi-chevron-right" style={{ marginLeft: '4px' }}></i>
                                    </button>
                                 )}
                        </div>
                    </div>
